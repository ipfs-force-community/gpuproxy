...
impl ProofRpc for ProofImpl {
    fn submit_task(&self,
        ...
        Ok(self.pool.add(addr, self.worker_id.unwrap().clone(), hex_prover_id, sector_id, scp1o).unwrap())
    }
...
pub fn register(io: &mut IoHandler, worker_id: Option<String>, pool:  Arc<dyn Taskpool+ Send + Sync>) {
