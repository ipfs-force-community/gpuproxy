...
type C2ProxyWorkerStruct struct {
	Internal struct {
		...
		RecordError func(p0 string, p1 string, p2 string) (bool, error) ``

		RecordProof func(p0 string, p1 string, p2 string) (bool, error) ``
	}
}
...
func (s *C2ProxyClientStruct) GetTask(p0 string) (Task, error) {
	return s.Internal.GetTask(p0)
}

func (s *C2ProxyClientStub) GetTask(p0 string) (Task, error) {
...
func (s *C2ProxyWorkerStruct) RecordError(p0 string, p1 string, p2 string) (bool, error) {
	return s.Internal.RecordError(p0, p1, p2)
}

func (s *C2ProxyWorkerStub) RecordError(p0 string, p1 string, p2 string) (bool, error) {
	return false, xerrors.New("method not supported")
}

func (s *C2ProxyWorkerStruct) RecordProof(p0 string, p1 string, p2 string) (bool, error) {
	return s.Internal.RecordProof(p0, p1, p2)
}

func (s *C2ProxyWorkerStub) RecordProof(p0 string, p1 string, p2 string) (bool, error) {
	return false, xerrors.New("method not supported")
}
