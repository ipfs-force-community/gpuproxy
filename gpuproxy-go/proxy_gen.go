...
type C2ProxyClientStruct struct {
	...
	SubmitC2Task func(p0 context.Context, p1 []byte, p2 string, p3 ProverId, p4 int64) (string, error) ``
...
func (s *C2ProxyClientStruct) SubmitC2Task(p0 context.Context, p1 []byte, p2 string, p3 ProverId, p4 int64) (string, error) {
	return s.Internal.SubmitC2Task(p0, p1, p2, p3, p4)
}

func (s *C2ProxyClientStub) SubmitC2Task(p0 context.Context, p1 []byte, p2 string, p3 ProverId, p4 int64) (string, error) {
